### [2.8.3](https://github.com/paradoxxxzero/formol/compare/v2.8.2...v2.8.3)

- Update dependencies (and remove jest 24 transitive dep)
- Add url native type field

### [2.8.2](https://github.com/paradoxxxzero/formol/compare/v2.8.1...v2.8.2)

- Add support for a ButtonsWrapper components prop
  to add a wrapper around submit and cancel buttons

### [2.8.1](https://github.com/paradoxxxzero/formol/compare/v2.8.0...v2.8.1)
